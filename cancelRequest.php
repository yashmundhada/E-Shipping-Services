...
$query = "INSERT INTO cancelrequest (trackingId,senderEmail,sender_name) VALUES ('$tr', '$email', '$name')";
mysqli_query($conn,$query);
if($query){
header("Location: userOrderCancelReq.php");
}
}
?>
<!DOCTYPE html>
...
Name" required>
<input type="text" name="semail" id="ip1" placeholder="Enter Your 
Email" required>
