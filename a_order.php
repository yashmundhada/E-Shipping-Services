  ...
  <li style="float:right"><a href="logout.php">Logout</a></li>
        ...
        <table class="content-table">
            ...
            <tbody>
                    ...
                    $i = 1;
                    $where=" ";
                    $qry = $conn->query("SELECT * from orders $where order by  id asc ");
                    ...
                    <tr>
                        ...
                        <td>
                        <div class="btn">
                        <a href="editOrder.php?DID=<?php echo $row['id'] ?>">Edit</a>
                        <a href="viewOrderDetails.php?DID=<?php echo $row['id']?>">View</a>
                        </div>
                    </td>
                </tr>
                <?php endwhile; ?>
