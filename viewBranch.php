  ...
  <li style="float:right"><a href="logout.php">Logout</a></li>
        ...
        <table class="content-table">
            ...
            <tbody>
            	<?php
                    $i = 1;
                    $qry = $conn->query("SELECT * FROM branches order by id asc; ");
                    ...
                    <tr>
                        ...
                        <td><b><?php echo ucwords($row['city'].', '.$row['state']) ?></b></td>
                         ...
                         <td><b><?php echo ucwords($row['pincode']) ?></b></td>
                        <td><b><?php echo $row['contact'] ?></b></td>
                        <td>
                    	<div class="btn">
                    		<a href="editBranch.php?id=<?php echo $row['id'] ?>">Edit</a>
                    	<a href="deleteBranch.php?dID=<?php echo $row['id'] ?>">Delete</a>
                    	</div>
                    </td>
                </tr>
            <?php 
